...
## Docker Container Lifecycle
  Docker conatiner lifesysle is managed by `Docker Engine`. Docker Engine is comprises of two main components which are `Docker Client(CLI)` and `Docker Daemon`.
